...
class MusicService : Service() {
    ...
    fun showNotification(playPauseBtn : Int){
        ...
        val notification = NotificationCompat.Builder(baseContext, ApplicationClass.CHANNEL_ID)
            .setContentTitle(MusicPlayerActivity.audioList[MusicPlayerActivity.songPosition].audioName)
            .setContentText(MusicPlayerActivity.audioList[MusicPlayerActivity.songPosition].audioArtist)
            .setSmallIcon(R.drawable.ic_notification)
            .setLargeIcon(MediaStore.Images.Media.getBitmap(contentResolver, Uri.parse(MusicPlayerActivity.audioList[MusicPlayerActivity.songPosition].audioImage)))
