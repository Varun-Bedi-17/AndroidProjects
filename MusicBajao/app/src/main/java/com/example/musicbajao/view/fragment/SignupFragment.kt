...
class SignupFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(this, SignupViewModelFactory(contextI)).get(SignupViewModel::class.java)
        ...
        viewModel.navigateToSignupsSplashScreen.observe(viewLifecycleOwner) {
            if (it == true) {
                ...
                fragManager.beginTransaction().replace(R.id.frameLayout, fragment).addToBackStack(null).commit()
            }
        }
